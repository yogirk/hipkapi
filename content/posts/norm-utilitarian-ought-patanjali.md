---
title: Norm, utilitarian ought,  Patanjali
date: '2011-03-19T01:18:12+05:30'
draft: false
description: ''
author: hipkapi
categories:
...
These articles could be talking about ‘rules’ (understood as ‘obligations’) and ‘rule following’: in that case, probably they are trying to get at the logical and semantic ideas underlying such obligations as ‘grammatical’ obligations (the obligation to follow rules of grammar), ‘legal’ obligations (the obligation to follow a statute), ‘traffic’ obligations (traffic rules that determine the behaviours of the driver) and such like. These ‘obligations’ could either be seen as generic obligations (of which ‘deontic’ obligations are a special case) or define deontic obligations differently altogether. The ‘deontic’ logics I know take the second route. I surmise that formalization of Mimasa would not (could not, in my story) give us deontic obligations of the type we get from Modal Theoretical Semantics (or from Model Theory, in general).
