---
title: Knowledge and Bullshit about Daffodil
date: '2017-10-09T15:38:53+05:30'
draft: false
description: ''
author: hipkapi
categories:
...
Q: If we prepare the mind with the right context, might this story or some other of our stories not provide a way to get to the framework that is currently obscured to us and elusive?

Yes, they would. But the issue is how do we prepare the mind with the right context? Since this is the question and I cannot answer it in any simple fashion, let me use this imagery.

Imagine that we have a huge and gigantic heap of things. We know that this heap contains many things: multiple kinds of seeds, different kinds of fertilizers, various types of earth, incredibly different kinds of instruments. There are also any number of manuscripts half eaten by dust written in a language you do not understand, even if you can read the letters. And printed books (with missing title pages, etc.) written in English even if you cannot know whether they are the ‘originals’ or translations and, if the latter, what they translate. Suppose that you want to grow a rare rose. You know that all the requirements for growing that rose are at hand. Question: how do you choose the right things to grow that rose?

This is where we are. Our culture is that heap. We have our Sanskrit books and many other books in English that allegedly ‘translate’. Our task is to cultivate the mind. In principle, we have all we need to complete the task. Question: how do we do go about doing it? Do we first need to read a translation (of what? God alone knows) or do we just randomly pick something from the heap and go forward?
